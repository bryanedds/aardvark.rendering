...
type ShaderUniformParameter =
    ...
    | AccelerationStructureParameter of name : string * set : int * binding : int
    ...
    member x.Name =
        match x with
            ...
            | AccelerationStructureParameter (name, _, _) -> name
    ...
    member x.DescriptorSet =
        match x with
            ...
            | AccelerationStructureParameter (_, set, _) -> set
    ...
    member x.Binding =
        match x with
            ...
            | AccelerationStructureParameter (_, _, binding) -> binding
